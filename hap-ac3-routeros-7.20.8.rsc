...
# ============================================================================
# One administrator host example: "192.168.1.101/32". Using /24 trusts every
# host in 192.168.1.0/24, not only .101.
...
# With no uncommented leases, DHCP_MANAGED intentionally gives no client an IP.
